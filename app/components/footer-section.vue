<template>
  <footer
    class="flex flex-col bg-gray-50 items-center justify-around w-full py-16 text-sm text-gray-800/70"
  >
    <div class="flex items-center gap-8">
      <a
        href="/"
        class="font-medium text-gray-500 hover:text-black transition-all"
      >
        Home
      </a>
      <a
